 ...
 */
public class LMFEA_2 extends Algorithm {
    ...
    public LMFEA_2(Problem prob, int POPSIZE, int maxEvals, int H) {
        System.out.println("LMFEA_2 is running");
        this.prob = prob;
...
//        System.out.println("Adaptive LMFEA 2 is running on seed = " + seed);
