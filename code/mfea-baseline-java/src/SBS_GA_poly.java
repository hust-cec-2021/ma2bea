 ...
 */
public class SBS_GA_poly extends Algorithm {
    ...
    public SBS_GA_poly(Problem prob, int POPSIZE, int maxEvals) {
        this.prob = prob;
    ...
    public ArrayList<Individual> run(int seed, double[][] data) {
        ...
        System.out.println("SBS-GA poly is running on seed = " + seed);
