...
def calculate_scalar_fitness(factorial_cost):
    return 1 / \
        np.min(np.argsort(np.argsort(factorial_cost, axis=0), axis=0) + 1, axis=1)

# MULTIFACTORIAL EVOLUTIONARY WITH TRANSFER PARAMETER ESTIMATION HELPER
# FUNCTIONS
